...
class GenotypedVariant {
    ...
    static GenotypedVariant of(CuratedVariant curatedVariant) {
        return of(curatedVariant, null);
    }

    static GenotypedVariant of(CuratedVariant curatedVariant, Genotype genotype) {
