...
/**
 * Very frequently we need an {@link ObservableDataComponent} that is also a {@link javafx.scene.layout.HBox}. This base class handles
 * setting listeners to the {@link #dataProperty()}.
 *
 * @param <T> type of observable data.
 */
public abstract class HBoxBindingObservableDataComponent<T> extends HBoxObservableDataComponent<T> {
