...
public class BaseObservableIndividual {
    ...
    private final ObservableList<ObservableDiseaseStatus> diseaseStatuses = FXCollections.observableList(new LinkedList<>());
    private final ObservableMap<String, Genotype> genotypes = FXCollections.observableMap(new HashMap<>());
    ...
    protected BaseObservableIndividual(Builder<?> builder) {
        ...
        this.phenotypicFeatures.addAll(builder.observablePhenotypicFeatures);
        this.diseaseStatuses.addAll(builder.observableDiseaseStatuses);
    ...
    public abstract static class Builder<T extends Builder<T>> {
        ...
        private final List<ObservablePhenotypicFeature> observablePhenotypicFeatures = new LinkedList<>();
        private final List<ObservableDiseaseStatus> observableDiseaseStatuses = new LinkedList<>();
