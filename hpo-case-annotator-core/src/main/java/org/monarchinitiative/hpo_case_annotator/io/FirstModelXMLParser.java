...
import org.monarchinitiative.hpo_case_annotator.first_model.MutationReader;
...
public class FirstModelXMLParser {
    ...
    /**
     * This method performs all the heavy lifting of moving data from {@link org.monarchinitiative.hpo_case_annotator.first_model.mutation.Variant}
     * and {@link Validation} into the {@link Variant} class.
     * @param var {@link org.monarchinitiative.hpo_case_annotator.first_model.mutation.Variant} with data and
     * @param validation {@link Validation} data to be moved into the
     * @return {@link Variant} object
     */
    private static Variant mapVariant(org.monarchinitiative.hpo_case_annotator.first_model.mutation.Variant var,
     ...
     */
    private static boolean isComplete(org.monarchinitiative.hpo_case_annotator.first_model.mutation.Variant var) {
