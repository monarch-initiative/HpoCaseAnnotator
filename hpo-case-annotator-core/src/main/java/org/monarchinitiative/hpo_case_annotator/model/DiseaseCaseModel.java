...
import org.monarchinitiative.hpo_case_annotator.io.JSONHpoDeserializer;
import org.monarchinitiative.hpo_case_annotator.io.JSONVariantDeserializer;
...
public final class DiseaseCaseModel {
    ...
    @JsonDeserialize(using = JSONVariantDeserializer.class)
    ...
    /** HPO info */
    @JsonDeserialize(using = JSONHpoDeserializer.class)
