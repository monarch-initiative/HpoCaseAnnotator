...
public class Codecs {
    ...
    public static DiseaseCaseModel diseaseCase2DiseaseCaseModel(DiseaseCase dc) {
        ...
        // FamilyInfo
        final FamilyInfo familyInfo = new FamilyInfo();
        ...
        // Biocurator
        final Biocurator biocurator = new Biocurator();
    ...
    /**
     * @return {@link BiFunction} accepting two variants ({@link org.monarchinitiative.hpo_case_annotator.model.proto.Variant}, {@link Variant}).
     * The data common to all subclasses of the {@link Variant} class is copied from the {@link org.monarchinitiative.hpo_case_annotator.model.proto.Variant} here.
     * The BiFunction returns the 2nd argument (the same instance) with initialized values.
     */
    private static BiFunction<org.monarchinitiative.hpo_case_annotator.model.proto.Variant, Variant, Variant> initializeCommonFields() {
    ...
    private static Function<Variant, org.monarchinitiative.hpo_case_annotator.model.proto.Variant> dcmVariantToVariant() {
        return v -> {
