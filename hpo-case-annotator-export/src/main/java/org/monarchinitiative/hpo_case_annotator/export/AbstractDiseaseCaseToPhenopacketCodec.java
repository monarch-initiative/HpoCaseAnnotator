 ...
 * </p>
 */
// TODO - may not be necessary anymore since we dropped support for SQUIRLS phenopackets
public abstract class AbstractDiseaseCaseToPhenopacketCodec implements Codec<DiseaseCase, Phenopacket> {
    ...
    AbstractDiseaseCaseToPhenopacketCodec() {
        ...
        try (InputStream is = AbstractDiseaseCaseToPhenopacketCodec.class.getResourceAsStream("phenopacket_version.properties")) {
            properties.load(is);
        } catch (IOException e) {
