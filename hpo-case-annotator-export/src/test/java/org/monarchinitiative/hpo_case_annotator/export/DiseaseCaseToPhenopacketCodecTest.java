...
import org.monarchinitiative.hpo_case_annotator.export.test_resources.PhenoPacketTestUtil;
...
public class DiseaseCaseToPhenopacketCodecTest {
    ...
    public void diseaseCaseToPhenopacket() {
        ...
        assertThat(phenotypesList, hasItems(
                PhenotypicFeature.newBuilder()
                        .setType(PhenoPacketTestUtil.ontologyClass("HP:0003498", "Disproportionate short stature"))
                        ...
                        .build(),
                PhenotypicFeature.newBuilder()
                        .setType(PhenoPacketTestUtil.ontologyClass("HP:0007957", "Corneal opacity"))
                        .addEvidence(Evidence.newBuilder()
                                .setEvidenceCode(AbstractDiseaseCaseToPhenopacketCodec.TRACEABLE_AUTHOR_STATEMENT)
                                .setReference(ExternalReference.newBuilder().setId("PMID:23954224").setDescription("First functional analysis of a novel splicing mutation in the B3GALTL gene by an ex vivo approach in Tunisian patients with typical Peters plus syndrome").build())
                                .build())
                        .build(),
                PhenotypicFeature.newBuilder()
                        .setType(PhenoPacketTestUtil.ontologyClass("HP:0000268", "Dolichocephaly"))
                        .addEvidence(Evidence.newBuilder()
                                .setEvidenceCode(AbstractDiseaseCaseToPhenopacketCodec.TRACEABLE_AUTHOR_STATEMENT)
                                .setReference(ExternalReference.newBuilder().setId("PMID:23954224").setDescription("First functional analysis of a novel splicing mutation in the B3GALTL gene by an ex vivo approach in Tunisian patients with typical Peters plus syndrome").build())
                                .build())
                        .build(),
                PhenotypicFeature.newBuilder()
                        .setType(PhenoPacketTestUtil.ontologyClass("HP:0000311", "Round face"))
                        .addEvidence(Evidence.newBuilder()
                                .setEvidenceCode(AbstractDiseaseCaseToPhenopacketCodec.TRACEABLE_AUTHOR_STATEMENT)
                                .setReference(ExternalReference.newBuilder().setId("PMID:23954224").setDescription("First functional analysis of a novel splicing mutation in the B3GALTL gene by an ex vivo approach in Tunisian patients with typical Peters plus syndrome").build())
                                .build())
                        .build(),
                PhenotypicFeature.newBuilder()
                        .setType(PhenoPacketTestUtil.ontologyClass("HP:0011451", "Congenital microcephaly"))
                        .addEvidence(Evidence.newBuilder()
                                .setEvidenceCode(AbstractDiseaseCaseToPhenopacketCodec.TRACEABLE_AUTHOR_STATEMENT)
                                .setReference(ExternalReference.newBuilder().setId("PMID:23954224").setDescription("First functional analysis of a novel splicing mutation in the B3GALTL gene by an ex vivo approach in Tunisian patients with typical Peters plus syndrome").build())
                                .build())
                        .build(),
                PhenotypicFeature.newBuilder()
                        .setType(PhenoPacketTestUtil.ontologyClass("HP:0004325", "Decreased body weight"))
                        .addEvidence(Evidence.newBuilder()
                                .setEvidenceCode(AbstractDiseaseCaseToPhenopacketCodec.TRACEABLE_AUTHOR_STATEMENT)
                                .setReference(ExternalReference.newBuilder().setId("PMID:23954224").setDescription("First functional analysis of a novel splicing mutation in the B3GALTL gene by an ex vivo approach in Tunisian patients with typical Peters plus syndrome").build())
                                .build())
        ...
        assertThat(diseasesList, hasItem(Disease.newBuilder()
                .setTerm(PhenoPacketTestUtil.ontologyClass("OMIM:261540", "PETERS-PLUS SYNDROME"))
                .build()));
    ...
    public void diseaseCaseWithStructuralVariantToPhenopacket() {
        ...
        assertThat(pp.getPhenotypicFeaturesList(), hasItems(
                PhenotypicFeature.newBuilder()
                        .setType(PhenoPacketTestUtil.ontologyClass("HP:0011453", "Abnormality of the incus"))
                        .addEvidence(Evidence.newBuilder()
                                .setEvidenceCode(AbstractDiseaseCaseToPhenopacketCodec.TRACEABLE_AUTHOR_STATEMENT)
                        ...
                        .build(),
                PhenotypicFeature.newBuilder()
                        .setType(PhenoPacketTestUtil.ontologyClass("HP:0000405", "Conductive hearing impairment"))
                        .addEvidence(Evidence.newBuilder()
                                .setEvidenceCode(AbstractDiseaseCaseToPhenopacketCodec.TRACEABLE_AUTHOR_STATEMENT)
                                .setReference(ExternalReference.newBuilder()
                                        .setId("PMID:22712005")
                        ...
                        .build(),
                PhenotypicFeature.newBuilder()
                        .setType(PhenoPacketTestUtil.ontologyClass("HP:0025336", "Delayed ability to sit"))
                        .addEvidence(Evidence.newBuilder()
                                .setEvidenceCode(AbstractDiseaseCaseToPhenopacketCodec.TRACEABLE_AUTHOR_STATEMENT)
                                .setReference(ExternalReference.newBuilder()
                                        .setId("PMID:22712005")
                        ...
                        .build(),
                PhenotypicFeature.newBuilder()
                        .setType(PhenoPacketTestUtil.ontologyClass("HP:0000750", "Delayed speech and language development"))
                        .addEvidence(Evidence.newBuilder()
                                .setEvidenceCode(AbstractDiseaseCaseToPhenopacketCodec.TRACEABLE_AUTHOR_STATEMENT)
                                .setReference(ExternalReference.newBuilder()
                                        .setId("PMID:22712005")
        ...
        assertThat(variant.getZygosity(), equalTo(PhenoPacketTestUtil.HET));
        ...
        assertThat(diseasesList, hasSize(1));
        assertThat(diseasesList, hasItem(Disease.newBuilder()
                .setTerm(PhenoPacketTestUtil.ontologyClass("OMIM:154500", "TREACHER COLLINS SYNDROME 1; TCS1"))
                .build()));
    ...
    public void diseaseCaseWithBreakendVariantToPhenopacket() {
        ...
        MatcherAssert.assertThat(variant.getZygosity(), Matchers.is(PhenoPacketTestUtil.HET));
    }
}