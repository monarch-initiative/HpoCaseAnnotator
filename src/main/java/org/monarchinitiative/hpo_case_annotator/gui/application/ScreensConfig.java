...
public class ScreensConfig {
    ...
    @Bean
    public ShowValidationResultsController showValidationResultsController() {
        return new ShowValidationResultsController();
    }


    public FXMLDialog showValidationResultsDialog() {
        return new FXMLDialog.FXMLDialogBuilder()
                .setDialogController(showValidationResultsController())
                .setFXML(getClass().getResource("/fxml/ShowValidationResultsView.fxml"))
                .setOwner(window)
                .setModality(Modality.APPLICATION_MODAL)
                .setStageStyle(StageStyle.DECORATED)
                .build();
    ...
    public FXMLDialog showEditPublicationDialog() {
        return new FXMLDialog.FXMLDialogBuilder()
                .setDialogController(showEditPublicationController())
                .setFXML(getClass().getResource("/fxml/ShowEditPublicationView.fxml"))
                .setOwner(window)
                .setModality(Modality.APPLICATION_MODAL)
                .setStageStyle(StageStyle.DECORATED)
                .build();
