...
public class JsonStudyParserTest {
    ...
    private static List<CuratedVariant> getVariants() {
        ...
        SplicingVariantMetadata splicingVariantMetadata = SplicingVariantMetadata.of("ACGT[A/C]TCGA", "coding", "coding|missense", true, false, true, false, false, true, false, false, true, false, false);
                  ...
                  "variants" : [ {
                    ...
                    "variantValidation" : {
                      ...
                      "validation" : {
                        ...
                        "variantClass" : "coding",
                        "pathomechanism" : "coding|missense",
                        "cosegregation" : true,
                        "comparability" : false,
    ...
    public void deserializeFamilyStudy() throws Exception {
        ...
        Study study = parser.deserialize(payload);
    ...
    public void roundTripFamilyStudy() throws IOException {
        ...
        String serialized = jsonStudyParser.serialize(familyStudy);
        Study deserialized = jsonStudyParser.deserialize(serialized);
    ...
    public void roundTripCohortStudy() throws IOException {
        ...
        String serialized = jsonStudyParser.serialize(cohortStudy);
        Study deserialized = jsonStudyParser.deserialize(serialized);
