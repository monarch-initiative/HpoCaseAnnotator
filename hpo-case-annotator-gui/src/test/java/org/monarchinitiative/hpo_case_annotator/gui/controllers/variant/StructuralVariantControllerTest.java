...
public class StructuralVariantControllerTest extends ApplicationTest {

    @Inject
    private Injector injector;

    private StructuralVariantController controller;
...
//        }
    ...
    public void start(Stage stage) throws Exception {
        FXMLLoader loader = new FXMLLoader(MendelianVariantController.class.getResource("StructuralVariant.fxml"));
