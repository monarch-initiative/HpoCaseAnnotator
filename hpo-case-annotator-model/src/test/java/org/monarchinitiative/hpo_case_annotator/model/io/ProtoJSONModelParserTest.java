...
public class ProtoJSONModelParserTest {
    ...
    /**
     * This test demonstrates that the parser is also able to read data from deprecated variant fields.
     *
    ...
    @Test
    public void v2IsParsedCorrectly() {
        // TODO - implement
    }
    ...
    public void modelIsSavedCorrectlyAsV2() throws Exception {
        String expected;
        Path expectedContentPath = Paths.get(getClass().getResource("expected-v2-Aznarez-2003-CFTR.json").toURI());
